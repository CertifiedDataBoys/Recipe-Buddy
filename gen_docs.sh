...
printf "=========================================================\n"
docker run --rm -v $PWD/app:/app python:3.10.0 /bin/bash -c 'cd ./app/ ; pip install -r ./pip-requirements.txt ; rm -r ./docs_temp/ ; pdoc --logo https://placedog.net/300?random -d google -o./docs_temp ../app ./blueprints/ ./database/ ./models/ ./templates/ ./testing/'
