    ...
    with app.app_context():
        ...
        recipes = [
            Recipe(pk=1, title="BLT 🥪",
                   ...
                   description="MM...FOOD\nYummy BLT!",
                   type="Sandwich",
                   uploaded=datetime.now(), uploaded_by=1, is_private=False),
            Recipe(pk=2, title="Bread sandwich",
                   ...
                   type="Sandwich",
                   uploaded=datetime.now(), uploaded_by=2, is_private=False),
            Recipe(pk=3, title="Side salad",
                   subtitle="Gross",
                   description="I hate salad",
                   type="Side",
                   uploaded=datetime.now(), uploaded_by=1, is_private=True),
